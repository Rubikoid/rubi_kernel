...
size_t last_page_ID;
volatileuint32_t* page_directory_ptr;
volatileuint32_t* page_table_ptr;

void init_memory_manager() {
    last_page_ID = VIRT_BASE + KERNEL_TABLE_COUNT * TABLE_SIZE + PAGE_SIZE;  // additional page for why not
    page_directory_ptr = (volatileuint32_t* )&boot_page_directory;
    page_table_ptr = (volatileuint32_t* )&boot_page_table;
}
